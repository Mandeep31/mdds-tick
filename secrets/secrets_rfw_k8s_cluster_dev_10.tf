...
module "rfw-data-api-platform" {
  source = "git::https://github.theocc.com/platform-org/tf-modules-app.git//risk_framework/secrets/api_secrets?ref=master"
  providers = {
    rancher2 = "rancher2.dev"
  }
  project_id = "${module.riskframework_K8S_dev_10_project.project_id}"
  ...
  module "rfw-dev-okta" {
  source = "git::https://github.theocc.com/platform-org/tf-modules-app.git//risk_framework/secrets/okta_secrets?ref=master"
  providers = {
    rancher2 = "rancher2.dev"
  }
  project_id = "${module.riskframework_K8S_dev_10_project.project_id}"
